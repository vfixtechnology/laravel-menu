...
namespace Vfixtechnology\Menu\Models;
...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('Vfixtechnology\Menu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('Vfixtechnology\Menu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
